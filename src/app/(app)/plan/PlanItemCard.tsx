...
export default function PlanItemCard({ item, onRefresh }: PlanItemCardProps) {
  ...
  return (
    <div className={`rounded-xl border px-2.5 py-2 text-xs transition-opacity ${done ? "opacity-50 bg-gray-50 border-gray-100" : "bg-white border-gray-200"}`}>
